...
// Only wire the videoservice plugin when videbo is enabled (VIDEO_API_SECRET
// is injected by videbo.yml / videbobehat.yml, which are opt-in).
if (getenv('VIDEO_API_SECRET')) {
